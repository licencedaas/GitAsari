...
public class detlles_derrota_v12 {

    FirebaseFirestore bdNeutro;
    private  VideoView v1;


    public detlles_derrota_v12(Context context1) {
        ...
        dialog.setContentView(R.layout.cuadro_dialogo_v12__derrota);


        v1 = (VideoView)  dialog.findViewById(R.id.derrotaViedeo_v12);
        ...
        ImageButton b1 = (ImageButton) dialog.findViewById(R.id.v12_derrota_b1);


        bdNeutro = FirebaseFirestore.getInstance();
        contexto val = new contexto();
        TextView l1 = (TextView) dialog.findViewById(R.id.v12_derrota_l1);
        TextView l2 = (TextView) dialog.findViewById(R.id.v12_derrota_l2);
        TextView l3 = (TextView) dialog.findViewById(R.id.v12_derrota_l3);
        ...
        bdNeutro.collection("BDcalabozo").document(val.getKeyRutaDungeon1())
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                if(documentSnapshot.exists()){
                    ...
                    val.setKeyPuntosV4_12(documentSnapshot.getString("lvl12"));
                    ...
                    val.setKeyEstado12(documentSnapshot.getString("puesto12"));
                                                                ...
                                                                if (val.getKeyCalabozolvl8().equals(val.getKeyNick())) {
                                                                    ...
                                                                    if (val.getKeyCalabozolvl9().equals(val.getKeyNick())) {
                                                                        ...
                                                                        if (val.getKeyCalabozolvl10().equals(val.getKeyNick())) {
                                                                            val.setKeyDuelista2(val.getKeyCalabozolvl9());
                                                                        }else{
                                                                            if (val.getKeyCalabozolvl11().equals(val.getKeyNick())) {
                                                                                val.setKeyDuelista2(val.getKeyCalabozolvl12());
                                                                            }else{
                                                                    ...
                                                                    if (val.getKeyEstado9().equals("esperando")) {
                                                                        if (val.getKeyEstado10().equals("esperando")) {
                                                                            if (val.getKeyEstado11().equals("esperando")) {
                                                                                if (val.getKeyEstado12().equals("esperando")) {
                                                                                    dato2.put("lvl12", "1");
                                                                                    dato2.put("puesto12", val.getKeyCalabozolvl1());
                                                                                }else {

                                                                                    dato2.put("lvl11", "1");
                                                                                    dato2.put("puesto11", val.getKeyCalabozolvl1());
                                                                                }
                                                                            }else {

                                                                                dato2.put("lvl10", "1");
                                                                                dato2.put("puesto10", val.getKeyCalabozolvl1());
                                                                            }
                                                                        }else {
                                                                        dato2.put("lvl9", "1");
                                                                        dato2.put("puesto9", val.getKeyCalabozolvl1());
                                                                      }
                                                                    }else {
                                                                        dato2.put("lvl8", "1");
                                                                        dato2.put("puesto8", val.getKeyCalabozolvl1());
                                                                    }
                                                                }else{
                                                                    dato2.put("lvl7", "1");
                                                                        ...
                                                                        if (val.getKeyEstado9().equals("esperando")) {
                                                                            if (val.getKeyEstado10().equals("esperando")) {
                                                                                if (val.getKeyEstado11().equals("esperando")) {
                                                                                    if (val.getKeyEstado12().equals("esperando")) {
                                                                                        dato2.put("lvl12", "1");
                                                                                        dato2.put("puesto12", val.getKeyCalabozolvl2());
                                                                                    }else {

                                                                                        dato2.put("lvl11", "1");
                                                                                        dato2.put("puesto11", val.getKeyCalabozolvl2());
                                                                                    }
                                                                                }else {

                                                                                    dato2.put("lvl10", "1");
                                                                                    dato2.put("puesto10", val.getKeyCalabozolvl2());
                                                                                }
                                                                            }else {
                                                                                dato2.put("lvl9", "1");
                                                                                dato2.put("puesto9", val.getKeyCalabozolvl2());
                                                                            }
                                                                        }else {
                                                                            dato2.put("lvl8", "1");
                                                                            dato2.put("puesto8", val.getKeyCalabozolvl2());
                                                                        }
                                                                    }else{
                                                                        dato2.put("lvl7", "1");
                                                                            ...
                                                                            if (val.getKeyEstado9().equals("esperando")) {
                                                                                if (val.getKeyEstado10().equals("esperando")) {
                                                                                    if (val.getKeyEstado11().equals("esperando")) {
                                                                                        if (val.getKeyEstado12().equals("esperando")) {
                                                                                            dato2.put("lvl12", "1");
                                                                                            dato2.put("puesto12", val.getKeyCalabozolvl3());
                                                                                        }else {

                                                                                            dato2.put("lvl11", "1");
                                                                                            dato2.put("puesto11", val.getKeyCalabozolvl3());
                                                                                        }
                                                                                    }else {

                                                                                        dato2.put("lvl10", "1");
                                                                                        dato2.put("puesto10", val.getKeyCalabozolvl3());
                                                                                    }
                                                                                }else {
                                                                                    dato2.put("lvl9", "1");
                                                                                    dato2.put("puesto9", val.getKeyCalabozolvl3());
                                                                                }
                                                                            }else {
                                                                                dato2.put("lvl8", "1");
                                                                                dato2.put("puesto8", val.getKeyCalabozolvl3());
                                                                            }
                                                                        }else{
                                                                            dato2.put("lvl7", "1");
                                                                                ...
                                                                                if (val.getKeyEstado9().equals("esperando")) {
                                                                                    if (val.getKeyEstado10().equals("esperando")) {
                                                                                        if (val.getKeyEstado11().equals("esperando")) {
                                                                                            if (val.getKeyEstado12().equals("esperando")) {
                                                                                                dato2.put("lvl12", "1");
                                                                                                dato2.put("puesto12", val.getKeyCalabozolvl4());
                                                                                            }else {
                                                                                    ...
                                                                                    if (val.getKeyEstado9().equals("esperando")) {
                                                                                        if (val.getKeyEstado10().equals("esperando")) {
                                                                                            if (val.getKeyEstado11().equals("esperando")) {
                                                                                                if (val.getKeyEstado12().equals("esperando")) {
                                                                                                    dato2.put("lvl12", "1");
                                                                                                    dato2.put("puesto12", val.getKeyCalabozolvl5());
                                                                                                }else {
                                                                                        ...
                                                                                        if (val.getKeyEstado9().equals("esperando")) {
                                                                                            if (val.getKeyEstado10().equals("esperando")) {
                                                                                                if (val.getKeyEstado11().equals("esperando")) {
                                                                                                    if (val.getKeyEstado12().equals("esperando")) {
                                                                                                        dato2.put("lvl12", "1");
                                                                                                        dato2.put("puesto12", val.getKeyCalabozolvl6());
                                                                                                    }else {
                                                                                            ...
                                                                                            if (val.getKeyEstado9().equals("esperando")) {
                                                                                                if (val.getKeyEstado10().equals("esperando")) {
                                                                                                    if (val.getKeyEstado11().equals("esperando")) {
                                                                                                        if (val.getKeyEstado12().equals("esperando")) {
                                                                                                            dato2.put("lvl12", "1");
                                                                                                            dato2.put("puesto12", val.getKeyCalabozolvl7());
                                                                                                        }else {
                                                                                                ...
                                                                                                if (val.getKeyEstado9().equals("esperando")) {
                                                                                                    if (val.getKeyEstado10().equals("esperando")) {
                                                                                                        if (val.getKeyEstado11().equals("esperando")) {
                                                                                                            if (val.getKeyEstado12().equals("esperando")) {
                                                                                                                dato2.put("lvl12", "1");
                                                                                                                dato2.put("puesto12", val.getKeyCalabozolvl8());
                                                                                                            }else {
                                                                                                    ...
                                                                                                    if (val.getKeyEstado9().equals("esperando")) {
                                                                                                        if (val.getKeyEstado10().equals("esperando")) {
                                                                                                            if (val.getKeyEstado11().equals("esperando")) {
                                                                                                                if (val.getKeyEstado12().equals("esperando")) {
                                                                                                                    dato2.put("lvl12", "1");
                                                                                                                    dato2.put("puesto12", val.getKeyCalabozolvl9());
                                                                                                                }else {
                                                                                                        ...
                                                                                                        if (val.getKeyEstado9().equals("esperando")) {
                                                                                                            if (val.getKeyEstado10().equals("esperando")) {
                                                                                                                if (val.getKeyEstado11().equals("esperando")) {
                                                                                                                    if (val.getKeyEstado12().equals("esperando")) {
                                                                                                                        dato2.put("lvl12", "1");
                                                                                                                        dato2.put("puesto12", val.getKeyCalabozolvl10());
                                                                                                                    }else {
                                                                                                            ...
                                                                                                            if (val.getKeyEstado9().equals("esperando")) {
                                                                                                                if (val.getKeyEstado10().equals("esperando")) {
                                                                                                                    if (val.getKeyEstado11().equals("esperando")) {
                                                                                                                        if (val.getKeyEstado12().equals("esperando")) {
                                                                                                                            dato2.put("lvl12", "1");
                                                                                                                            dato2.put("puesto12", val.getKeyCalabozolvl11());
                                                                                                                        }else {
                                                                                                                ...
                                                                                                                if (val.getKeyEstado9().equals("esperando")) {
                                                                                                                    if (val.getKeyEstado10().equals("esperando")) {
                                                                                                                        if (val.getKeyEstado11().equals("esperando")) {
                                                                                                                            if (val.getKeyEstado12().equals("esperando")) {
                                                                                                                                dato2.put("lvl12", "1");
                                                                                                                                dato2.put("puesto12", val.getKeyCalabozolvl12());
                                                                                                                            }else {

                                                                                                                                dato2.put("lvl11", "1");
                                                                                                                                dato2.put("puesto11", val.getKeyCalabozolvl12());
                                                                                                                            }
                                                                                                                            dato2.put("puesto11", val.getKeyCalabozolvl12());
                                                                                                                        }else {

                                                                                                                            dato2.put("lvl10", "1");
                                                                                                                            dato2.put("puesto10", val.getKeyCalabozolvl12());
                                                                                                                        }
                                                                                                                    }else {
                                                                                                                        dato2.put("lvl9", "1");
                                                                                                                        dato2.put("puesto9", val.getKeyCalabozolvl12());
                                                                                                                    }
                                                                                                                }else {
                                                                                                                    dato2.put("lvl8", "1");
                                                                                                                    dato2.put("puesto8", val.getKeyCalabozolvl12());
                                                                                                                }
                                                                                                            }else{
                                                                                                                dato2.put("lvl7", "1");
                                                                                                                dato2.put("puesto7", val.getKeyCalabozolvl12());
                                                                                                            }
                                                                                                        }else{
                                                                                                            dato2.put("lvl6", "1");
                                                                                                            dato2.put("puesto6", val.getKeyCalabozolvl12());}
                                                                                                    } else {
                                                                                                        dato2.put("lvl5", "1");
                                                                                                        dato2.put("puesto5", val.getKeyCalabozolvl12());
                                                                                                    } } else {
                                                                                                    dato2.put("lvl4", "1");
                                                                                                    dato2.put("puesto4", val.getKeyCalabozolvl12());
                                                                                                } } else {
                                                                                                dato2.put("lvl3", "1");
                                                                                                dato2.put("puesto3", val.getKeyCalabozolvl12());
                                                                                            } } else {
                                                                                            dato2.put("lvl2", "2");
                                                                                            dato2.put("puesto2", val.getKeyCalabozolvl12());
                                                                                            dato2.put("lvl1", "3");
                                                                                            dato2.put("puesto1", val.getKeyDuelista2());
                                                                                        } } }
                                                                                bdNeutro.collection("BDcalabozo").document(val.getKeyRutaDungeon1()).update(dato2);
