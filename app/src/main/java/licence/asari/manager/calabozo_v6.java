...
public class calabozo_v6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calabozo_v6);
        ...
        l7=(TextView) findViewById(R.id.v6_la);
        l8=(TextView) findViewById(R.id.v6_lb);
        l9=(TextView) findViewById(R.id.v6_lc);
        l10=(TextView) findViewById(R.id.v6_ld);
        l11=(TextView) findViewById(R.id.v6_le);
        l12=(TextView) findViewById(R.id.v6_lf);

        b1 = (Button) findViewById(R.id.calabozo_v6_b1);
        b2 = (ImageButton) findViewById(R.id.politicas_b1);
        b2.setVisibility(View.GONE);

        fondo1 =(ImageView) findViewById(R.id.ondo_dungeoxyzv6);//fondo_arquetipo_kuri
        fondo1.setVisibility(View.GONE);

        fondo2 =(ImageView) findViewById(R.id.fondo_arquetipo_kuriv6);//fondo_arquetipo_kuri
        ...
        try { if (val.getKeyPermisoInicio().equals("TRUE")) { b2.setVisibility(View.VISIBLE); val.setKeyCalabozoActivo("6");} }catch (Exception dfs){}
                                    ...
                                    .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                        ...
                                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                                            ...
                                            if (documentSnapshot.exists()) {
                                                ...
                                                l7.setText(val.getKeyParticipante1());
                                                l8.setText(val.getKeyParticipante2());
                                                l9.setText(val.getKeyParticipante3());
                                                l10.setText(val.getKeyParticipante4());
                                                l11.setText(val.getKeyParticipante5());
                    ...
                    if (val.getKeyCalabozolvl1().equals(val.getKeyNick())) {
                        ...
                        if (val.getKeyCalabozolvl2().equals(val.getKeyNick())) {
                            ...
                            if (val.getKeyCalabozolvl3().equals(val.getKeyNick())) {
                                ...
                                if (val.getKeyCalabozolvl1().equals("derrota")) {
                                    val.setKeyDuelista2(val.getKeyCalabozolvl2());
                                } else {
                                    if (val.getKeyCalabozolvl2().equals("derrota")) {
                                        val.setKeyDuelista2(val.getKeyCalabozolvl1());
                                    }
                                }
                                if(val.getKeyDuelista2().equals("auxiliar")) {
                                    Toast.makeText(getApplicationContext(), "ESPERA DUELISTA QUE SE DEFINA EL DUELO DE SUS RIVALES.", Toast.LENGTH_SHORT).show();
                                }else{llamadaDerrota();}
                            }else{
