...
public class detlles_derrota_v9 {

    FirebaseFirestore bdNeutro;
    private  VideoView v1;


    public detlles_derrota_v9(Context context1) {
        ...
        dialog.setContentView(R.layout.cuadro_dialogo_v9__derrota);


        v1 = (VideoView)  dialog.findViewById(R.id.derrotaViedeo_v9);
        ...
        ImageButton b1 = (ImageButton) dialog.findViewById(R.id.v9_derrota_b1);


        bdNeutro = FirebaseFirestore.getInstance();
        contexto val = new contexto();
        TextView l1 = (TextView) dialog.findViewById(R.id.v9_derrota_l1);
        TextView l2 = (TextView) dialog.findViewById(R.id.v9_derrota_l2);
        TextView l3 = (TextView) dialog.findViewById(R.id.v9_derrota_l3);
