...
if(val.getKeyEntradaLose().equals("nolose")){
      ...
      if(val.getKeyExclucion().equals("activo")){
        val.setKeyCalabozoActivo(val.getKeyConteo());
        val.setKeyCalabozoActivo(val.getKeyCalabozoActivo()+"lose");

    }else{
    val.setKeyCalabozoActivo(documentSnapshot.getString("salakeycalabozo"));
    val.setKeyJ11(Integer.parseInt(val.getKeyCalabozoActivo()));
    val.setKeyJ11(val.getKeyJ11()-2);
    val.setKeyCalabozoActivo(String.valueOf(val.getKeyJ11())+"lose");}

}else {
    val.setKeyCalabozoActivo(documentSnapshot.getString("salakeycalabozo"));
}
   bdNeutro.collection("BDcalabozo").document("tablaUp"+val.getKeyCalabozoActivo()).get()
   ...
   if(val.getKeyEntradaLose().equals("nolose")) {
       ...
       if(val.getKeyExclucion().equals("activo")){
           ...
           val.setKeyCalabozoActivo(val.getKeyCalabozoActivo().replaceAll("lose", ""));
       }
  }
 ...
 HashMap<String, Object> dato1 = new HashMap<>();
                               ...
                               if(val.getKeyEntradaLose().equals("nolose")) {
                                   val.setKeyCalabozoActivo(String.valueOf(val.getKeyJ1())+"lose");
                                                        }
...
if(val.getKeyDuelista2().equals(val.getKeyCalabozolvl4())){}
    ...
    if(val.getKeyCalabozoActivo().equals("7")){
        ...
        if (val.getKeyCalabozoActivo().equals("7lose")) {
            dato1.put("participante7", val.getKeyDuelista());
            bdNeutral.collection("BDcalabozo").document("tablaUp" + val.getKeyCalabozoActivo()).update(dato1);
            HashMap<String, Object> dato = new HashMap<>();
            dato.put("puestoN7", val.getKeyDuelista());
...
if (val.getKeyCalabozolvl9().equals("esperando")) {
    ...
    if(val.getKeyCalabozoActivo().equals("9")){
        ...
        b1.setVisibility(View.VISIBLE);
        bdNeutral.collection("BDcalabozo").document("calabozoUp" + val.getKeyCalabozoActivo()).update(dato);
        Toast.makeText(context1.getApplicationContext(), "Asignando puestos... Duelistas.9", Toast.LENGTH_SHORT).show();
    }else {
        if(val.getKeyCalabozoActivo().equals("9lose")){
            dato1.put("participante9", val.getKeyDuelista());
            bdNeutral.collection("BDcalabozo").document("tablaUp" + val.getKeyCalabozoActivo()).update(dato1);
            HashMap<String, Object> dato = new HashMap<>();
            dato.put("puestoN9", val.getKeyDuelista());
        ...
        if(val.getKeyJ1()==11){
            ...
            b1.setVisibility(View.VISIBLE);
            bdNeutral.collection("BDcalabozo").document("calabozoUp" + val.getKeyCalabozoActivo()).update(dato);
            Toast.makeText(context1.getApplicationContext(), "Asignando puestos... Duelistas.10", Toast.LENGTH_SHORT).show();
        }}
    ...
    if (val.getKeyCalabozolvl11().equals("esperando")) {
                                                   b1.setVisibility(View.VISIBLE);
                                                                        if(val.getKeyCalabozoActivo().equals("11")){
                                                                            dato1.put("participante11", val.getKeyDuelista());
                                                                            bdNeutral.collection("BDcalabozo").document("tablaUp" + val.getKeyCalabozoActivo()).update(dato1);
                                                                            HashMap<String, Object> dato = new HashMap<>();
                                                                            dato.put("puestoN11", val.getKeyDuelista());
                                                                            dato.put("participante11", val.getKeyDuelista());
                                                                            b1.setVisibility(View.VISIBLE);
                                                                            bdNeutral.collection("BDcalabozo").document("calabozoUp" + val.getKeyCalabozoActivo()).update(dato);
                                                                            Toast.makeText(context1.getApplicationContext(), "Asignando puestos... Duelistas.", Toast.LENGTH_SHORT).show();
                                                                        }else {
                                                                            if(val.getKeyCalabozoActivo().equals("12")){
                                                                                dato1.put("participante11", val.getKeyDuelista());
                                                                                dato1.put("participante12", val.getKeyDuelista2());
                                                                                bdNeutral.collection("BDcalabozo").document("tablaUp" + val.getKeyCalabozoActivo()).update(dato1);
                                                                                HashMap<String, Object> dato = new HashMap<>();
                                                                                dato.put("puestoN11", val.getKeyDuelista());
                                                                                dato.put("puestoN12", val.getKeyDuelista2());
                                                                                dato.put("participante11", val.getKeyDuelista());
                                                                                dato.put("participante12", val.getKeyDuelista2());
                                                                                b1.setVisibility(View.VISIBLE);
                                                                                bdNeutral.collection("BDcalabozo").document("calabozoUp" + val.getKeyCalabozoActivo()).update(dato);
                                                                                Toast.makeText(context1.getApplicationContext(), "Asignando puestos... Duelistas.", Toast.LENGTH_SHORT).show();
                                                                            }}
...
if(tabla_registro_dungeo_v6.idV4.size() == 0){
    if(val.getKeyEntradaLose().equals("nolose")){
        ...
        Toast.makeText(context1.getApplicationContext(), "Habilitando SALAS LOSE ... ", Toast.LENGTH_SHORT).show();
        bdNeutro.collection("BDcalabozo").document("Info").update(dato);

    }else {
        HashMap<String, Object> dato = new HashMap<>();
        dato.put("keyRegistroActivo", "eliminatoria");

        Toast.makeText(context1.getApplicationContext(), "Desactivando Pre-Registro ... ", Toast.LENGTH_SHORT).show();
        Toast.makeText(context1.getApplicationContext(), "Habilitando DUNGEON XYZ ... ", Toast.LENGTH_SHORT).show();
        bdNeutro.collection("BDcalabozo").document("Info").update(dato);
    }
}
 ...
 cerrar.setOnClickListener(new View.OnClickListener() {
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(tabla_registro_dungeo_v6.idV4.size()== 0){
                    ...
                    bdNeutro.collection("BDcalabozo").document("calabozoUp"+val.getKeyCalabozoActivo()).delete();
                    bdNeutro.collection("BDcalabozo").document("tablaUp"+val.getKeyCalabozoActivo()).delete();
                    ...
                    Toast.makeText(context1.getApplicationContext(), "Desactivando  DUNGEON XYZ ... ", Toast.LENGTH_SHORT).show();

                            Toast.makeText(context1.getApplicationContext(), "Lo sentimos no esta diponible..", Toast.LENGTH_SHORT).show();
   ...
   val.setKeyJ1(Integer.parseInt(val.getKeyCalabozoActivo()));
        ...
        if(val.getKeyEntradaLose().equals("nolose")) {
            ...
            bdNeutro.collection("BDcalabozo").document("tablaUp" + val.getKeyCalabozoActivo()).set(dato1);
            bdNeutro.collection("BDcalabozo").document("calabozoUp" + val.getKeyCalabozoActivo()).set(dato);
        }
    }
