...
public class detlles_derrota_v8 {

    FirebaseFirestore bdNeutro;
    private  VideoView v1;


    public detlles_derrota_v8(Context context1) {
        ...
        dialog.setContentView(R.layout.cuadro_dialogo_v8__derrota);


        v1 = (VideoView)  dialog.findViewById(R.id.derrotaViedeo_v8);
        ...
        ImageButton b1 = (ImageButton) dialog.findViewById(R.id.v8_derrota_b1);


        bdNeutro = FirebaseFirestore.getInstance();
        contexto val = new contexto();
        TextView l1 = (TextView) dialog.findViewById(R.id.v8_derrota_l1);
        TextView l2 = (TextView) dialog.findViewById(R.id.derrotaV8_l2);
        TextView l3 = (TextView) dialog.findViewById(R.id.derrotaV8_l3);
...
if (val.getKeyCalabozolvl1().equals(val.getKeyNick())) {
val.setKeyDuelista2(val.getKeyCalabozolvl2());
} else { if (val.getKeyCalabozolvl2().equals(val.getKeyNick())) {
val.setKeyDuelista2(val.getKeyCalabozolvl1());
} else { if (val.getKeyCalabozolvl3().equals(val.getKeyNick())) {
val.setKeyDuelista2(val.getKeyCalabozolvl4());
} else { if (val.getKeyCalabozolvl4().equals(val.getKeyNick())) {
val.setKeyDuelista2(val.getKeyCalabozolvl3());
} else { if (val.getKeyCalabozolvl5().equals(val.getKeyNick())) {
val.setKeyDuelista2(val.getKeyCalabozolvl6());
} else { if (val.getKeyCalabozolvl6().equals(val.getKeyNick())) {
    val.setKeyDuelista2(val.getKeyCalabozolvl5());
}else{ if (val.getKeyCalabozolvl7().equals(val.getKeyNick())) {
    val.setKeyDuelista2(val.getKeyCalabozolvl8());
} else{ if (val.getKeyCalabozolvl8().equals(val.getKeyNick())) {
    val.setKeyDuelista2(val.getKeyCalabozolvl7());
} } } } } } } } }
                               ...
                               if(val.getKeyDuelista2().equals("auxiliar")){
                                ...
                                //              Toast.makeText(context1.getApplicationContext(), "Duelista:  " +val.getKeyDuelista2(), Toast.LENGTH_SHORT).show();
