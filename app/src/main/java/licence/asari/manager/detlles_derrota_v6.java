...
public class detlles_derrota_v6 {

    FirebaseFirestore bdNeutro;
    private  VideoView v1;


    public detlles_derrota_v6(Context context1) {
        ...
        dialog.setContentView(R.layout.cuadro_dialogo_v6__derrota);


        v1 = (VideoView) dialog.findViewById(R.id.derrotaViedeo_v6);
        ...
        ImageButton b1 = (ImageButton) dialog.findViewById(R.id.derrotaV5_b1);


        bdNeutro = FirebaseFirestore.getInstance();
        contexto val = new contexto();
        TextView l1 = (TextView) dialog.findViewById(R.id.derrotaV6_l3);
        TextView l2 = (TextView) dialog.findViewById(R.id.derrotaV6_l2);
        TextView l3 = (TextView) dialog.findViewById(R.id.derrotaV6_l1);
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        if (documentSnapshot.exists()) {
                            ...
                            if (val.getKeyDuelista2().equals("auxiliar")) {
                                Toast.makeText(context1.getApplicationContext(), "Espere que los duelista que definan los duelos", Toast.LENGTH_SHORT).show();
                            } else {
                                ...
                                // Toast.makeText(context1.getApplicationContext(), ": "+val.getKeyCalabozolvl6(), Toast.LENGTH_SHORT).show();
                                if (val.getKeyCalabozolvl1().equals(val.getKeyNick())) {
                                    dato.put("puestoN1", "derrota");
                                    //         Toast.makeText(context1.getApplicationContext(), "1USUARIO: "+val.getKeyCalabozolvl2(), Toast.LENGTH_SHORT).show();
