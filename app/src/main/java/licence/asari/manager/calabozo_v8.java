...
public class calabozo_v8 extends AppCompatActivity {

    FirebaseFirestore bdNeutral, bdAzul,gremio;
    Button b1;
    TextView l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16;
    ImageButton b2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calabozo_v8);
        ...
        b2 = (ImageButton) findViewById(R.id.politicas_v8);
        b2.setVisibility(View.GONE);
        try { if (val.getKeyPermisoInicio().equals("TRUE")) { b2.setVisibility(View.VISIBLE); val.setKeyCalabozoActivo("8");} }catch (Exception dfs){}
        ...
        l1 = (TextView) findViewById(R.id.v8_l1);
        l2 = (TextView) findViewById(R.id.v8_l2);
        l3 = (TextView) findViewById(R.id.v8_l3);
        l4 = (TextView) findViewById(R.id.v8_l4);
        l5 = (TextView) findViewById(R.id.v8_l5);
        l6 = (TextView) findViewById(R.id.v8_l6);
        l7 = (TextView) findViewById(R.id.v8_l7);
        l8 = (TextView) findViewById(R.id.v8_l8);


        l9 = (TextView) findViewById(R.id.v8_la);
        l10 = (TextView) findViewById(R.id.v8_lb);
        l11 = (TextView) findViewById(R.id.v8_lc);
        l12 = (TextView) findViewById(R.id.v8_ld);
        l13 = (TextView) findViewById(R.id.v8_le);
        l14 = (TextView) findViewById(R.id.v8_lf);
        l15 = (TextView) findViewById(R.id.v8_lg);
        l16 = (TextView) findViewById(R.id.v8_lh);

        b1 = (Button) findViewById(R.id.calabozo_v8_b1);

        fondo1 =(ImageView) findViewById(R.id.ondo_dungeoxyzv8);//fondo_arquetipo_kuri
        fondo1.setVisibility(View.GONE);

        fondo2 =(ImageView) findViewById(R.id.fondo_arquetipo_kuriv8);//fondo_arquetipo_kuri
                                                                                        ...
                                                                                        if (val.getKeyNick().equals(val.getKeyCalabozolvl5())) {
                                                                                            ...
                                                                                            if (val.getKeyNick().equals(val.getKeyCalabozolvl6())) {
                                                                                                ...
                                                                                                if (val.getKeyNick().equals(val.getKeyCalabozolvl7())) {
                                                                                                    ...
                                                                                                    dato1.put("participante8", val.getKeyNick());
                                                                                                    bdNeutral.collection("BDcalabozo").document(val.getKeyRutaDungeon1()).update(dato1);
                                                                                                    HashMap<String, Object> dato = new HashMap<>();
                                                                                                    dato.put("puestoN8", val.getKeyNick());
                                                                                                    bdNeutral.collection("BDcalabozo").document(val.getKeyRutaDungeon2()).update(dato);
                                                                                                }
                                                                                            }
                                                                                        }
...
if (val.getKeyCalabozolvl1().equals(val.getKeyNick())) {
    ...
    public void llamadaDerrota() {
        contexto = this;
        new detlles_derrota_v8(contexto);
    }
