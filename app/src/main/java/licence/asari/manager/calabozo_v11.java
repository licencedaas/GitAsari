...
public class calabozo_v11 extends AppCompatActivity {

    FirebaseFirestore bdNeutral, bdAzul,gremio;
    Button b1;
    TextView l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16,l17,l18,l19,l20,l21,l22;
    ImageButton b2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calabozo_v11);
        ...
        l1 = (TextView) findViewById(R.id.v11_l1);
        l2 = (TextView) findViewById(R.id.v11_l2);
        l3 = (TextView) findViewById(R.id.v11_l3);
        l4 = (TextView) findViewById(R.id.v11_l4);
        l5 = (TextView) findViewById(R.id.v11_l5);
        l6 = (TextView) findViewById(R.id.v11_l6);
        l7 = (TextView) findViewById(R.id.v11_l7);
        l8 = (TextView) findViewById(R.id.v11_l8);
        l9 = (TextView) findViewById(R.id.v11_l9);
        l10 = (TextView) findViewById(R.id.v11_l10);
        l11 = (TextView) findViewById(R.id.v11_l11);

        l12 = (TextView) findViewById(R.id.v11_l12);
        l13 = (TextView) findViewById(R.id.v11_l13);
        l14 = (TextView) findViewById(R.id.v11_l14);
        l15 = (TextView) findViewById(R.id.v11_l15);
        l16 = (TextView) findViewById(R.id.v11_l16);
        l17 = (TextView) findViewById(R.id.v11_l17);
        l18 = (TextView) findViewById(R.id.v11_l18);
        l19 = (TextView) findViewById(R.id.v11_l19);
        l20 = (TextView) findViewById(R.id.v11_l20);
        l21 = (TextView) findViewById(R.id.v11_l21);
        l22 = (TextView) findViewById(R.id.v11_l22);

        fondo1 =(ImageView) findViewById(R.id.ondo_dungeoxyzv11);//fondo_arquetipo_kuri
        fondo1.setVisibility(View.GONE);

        fondo2 =(ImageView) findViewById(R.id.fondo_arquetipo_kuriv11);//fondo_arquetipo_kuri
        ...
        b2 = (ImageButton) findViewById(R.id.politicas_v11);
        b2.setVisibility(View.GONE);
        try { if (val.getKeyPermisoInicio().equals("TRUE")) { b2.setVisibility(View.VISIBLE); val.setKeyCalabozoActivo("11");} }catch (Exception dfs){}

        b1 = (Button) findViewById(R.id.calabozo_v11_b1);
    ...
    public void llamadaDerrota() {
        contexto = this;
        new detlles_derrota_v11(contexto);
    }
                                    ...
                                    .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                        ...
                                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                                            ...
                                            if (documentSnapshot.exists()) {
                                                ...
                                                l12.setText(val.getKeyParticipante1());
                                                l13.setText(val.getKeyParticipante2());
                                                l14.setText(val.getKeyParticipante3());
                                                l15.setText(val.getKeyParticipante4());
                                                l16.setText(val.getKeyParticipante5());
                                                l17.setText(val.getKeyParticipante6());
                                                l18.setText(val.getKeyParticipante7());
                                                l19.setText(val.getKeyParticipante8());
                                                l20.setText(val.getKeyParticipante9());
                                                l21.setText(val.getKeyParticipante10());
